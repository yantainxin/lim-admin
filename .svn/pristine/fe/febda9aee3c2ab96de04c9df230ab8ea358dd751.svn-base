...
layui.define(['layer', 'form'], function(exports){
  ...
  Edit.prototype.build = function(id, settings){
    ...
    ,toolbar = (tool && tool.length !=0)?'<div class="layui-unselect layui-layedit-tool">'+ tool +'</div>':''
  ...
  //激活编辑器
  Edit.prototype.focus = function(index){
  ...
  //获得编辑器对象
  Edit.prototype.getElement = function(index){
    var iframeWin = getWin(index);
    if(!iframeWin[0]) return;
    return $(iframeWin[0].document.body);
  };
  ...
  Edit.prototype.insertContent = function(index, content){
    var iframeWin = getWin(index);
    if(!iframeWin[0]) return;
    var iframeDOM = iframeWin[0].document;
    var range = Range(iframeWin[0].document);
    var selection = iframeDOM.getSelection();
    var elem = range.createContextualFragment(content);

    if(iframeDOM.selection){ //IE 
      range.pasteHTML($(elem).html()); 
      range.select();
    } else { //非IE
  ...
  var setIframe = function(editor, textArea, set){
    ...
    iframe.css({
      ...
      ,style = $(['<style>'
        ...
        ,'@font-face {'
        ,'font-family: "layui-icon";  /* project id 383321 */'
        ,'src: url("http://at.alicdn.com/t/font_383321_l96tdzxgeoim5cdi.eot");'
        ,'src: url("http://at.alicdn.com/t/font_383321_l96tdzxgeoim5cdi.eot?#iefix") format("embedded-opentype"),'
        ,'url("http://at.alicdn.com/t/font_383321_l96tdzxgeoim5cdi.woff") format("woff"),'
        ,'url("http://at.alicdn.com/t/font_383321_l96tdzxgeoim5cdi.ttf") format("truetype"),'
        ,'url("http://at.alicdn.com/t/font_383321_l96tdzxgeoim5cdi.svg#layui-icon") format("svg");'
        ,'}'
        ,'.layui-icon{'
        ...
        ,'.layui-layim-audio, .layui-layim-video, .layui-layim-file {max-width: 85px; display: inline-block; overflow: hidden; max-height: 120px; overflow: hidden;}'
        ,'.layui-layim-photos {max-height: 80%; display: inline-block; cursor: pointer}'

        ,'*{margin: 0; padding: 0;}'
        ,'body{padding: 10px; line-height: 20px; overflow-x: hidden; word-wrap: break-word; font: 14px Helvetica Neue,Helvetica,PingFang SC,Microsoft YaHei,Tahoma,Arial,sans-serif; -webkit-box-sizing: border-box !important; -moz-box-sizing: border-box !important; box-sizing: border-box !important;}'
        ,'a{color:#666; text-decoration:none;}a:hover{color:#666}'
