<template>
  <div class="wrapper">
    ...
    <el-row class="login" v-loading="loading" element-loading-text="拼命加载中">
      <div class="login-form" @keyup.enter="userLogin('sysadm')">
      <el-form :model="item" :rules="rules" ref="sysadm" label-width="80px">    
        ...
        <el-form-item class="text-center">
          <el-row :gutter="10">
          <el-col :span="12">
            <el-button class="element-block" @click="userLogin('sysadm')">登录</el-button>
          </el-col>          
          <el-col :span="12">
            <el-button class="element-block" @click="formReset('sysadm')">重置</el-button>
          </el-col> 
<!--           <el-col :span="8">
            <el-tooltip content="使用鸭梨通行证帐号登录">
            <el-button class="element-block" type="primary" @click="yaliPassport()"><img class="passport" src="../../../static/image/yali.png"/></el-button>
            </el-tooltip>
          </el-col> -->
          </el-row>
        </el-form-item>
<!--         <el-form-item>
          <el-row :gutter="10" class="text-gray">
            <el-col :span="12">注册新帐号？</el-col>
            <el-col :span="12" class="text-right">忘记密码？</el-col>
          </el-row>
        </el-form-item> -->
      </el-form>
      </div>
...
export default{
  ...
  methods: {
    ...
    yaliPassport() {
      location.href = 'http://ucenter.newyali.cn/client/auth/sys_auth_login?client_id=b655b0cecdf089ecdf08028c3abb4b3028c3abb44&app_secret=e4b1aa29055085cb7cbbe76c9ce12dc0&redirect_uri=http://' + location.host + '/sysadm/index.html%23/login';
    }
  }
}
</script>
