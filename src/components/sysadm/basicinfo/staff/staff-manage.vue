...
<el-row class="content-body" v-loading="loading" element-loading-text="拼命加载中">
    ...
    <el-table-column header-align="center" prop="staffPhone" label="手机" sortable></el-table-column>
    ...
    <el-table-column header-align="center" label="状态" sortable>
      <template scope="scope">
        <el-tag :type="scope.row.staffStatus == 1 ? 'primary' : 'success'" close-transition>
          <d-maps v-model="scope.row.staffStatus" :options="[{'value':0, 'label':'在职'}, {'value':1, 'label':'停职'}]"></d-maps></el-tag>
      </template>
    </el-table-column>
