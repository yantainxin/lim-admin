...
<!--         <el-row class="text-center">点击下图可更换头像</el-row>
        <el-upload class="uploader text-center" list-type="picture-card" 
            ...
            <img v-if="personal.adminAvatar" :src="personal.adminAvatar">
            <i v-else class="iconfont icon-plus"></i>
        </el-upload> -->
        <div class="text-left text-silver-dark">
          <i class="iconfont icon-admin"></i> {{personal.adminRealname}}，欢迎您！<br>
          <i class="iconfont icon-phone"></i> {{personal.adminPhone?personal.adminPhone:'暂未填写'}}<br>
          <i class="iconfont icon-email"></i> {{personal.adminEmail?personal.adminEmail:'暂未填写'}}
        </div>
        </el-popover>
